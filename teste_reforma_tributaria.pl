% Teste para REFORMA TRIBUTÁRIA
% Condições: Crise econômica alta + infraestrutura ruim

:- consult('data.pl').

% Configurar dados para ativar reforma tributária
configurar_reforma_tributaria(Pais) :-
    ...
    write('✓ Dados configurados para REFORMA TRIBUTÁRIA'), nl.

% Testar se a decisão está disponível
testar_reforma_tributaria(Pais) :-
    write('=== TESTE: REFORMA TRIBUTÁRIA ==='), nl, nl,
    
    (   decisao(Pais, reforma_tributaria, Meses)
...
executar_teste(Pais) :-
    write('========================================'), nl,
    write('TESTE: REFORMA TRIBUTÁRIA'), nl,
    write('========================================'), nl, nl,
